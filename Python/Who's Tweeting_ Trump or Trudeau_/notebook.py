...
help(plot_and_return_top_features)
print(plot_and_return_top_features.__doc__)

top_features = plot_and_return_top_features(tfidf_svc, tfidf_vectorizer, top_features=20)
...
trump_tweet = 'great thank to vietnam president today'
trudeau_tweet = 'amp le les du pour nous rt et la'
