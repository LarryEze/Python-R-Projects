...
# Prepare data
df_run_dist_annual = df_run['Distance (km)']['2018':'2013'].resample('A').sum()
...
# Prepare data
df_run_dist_wkly = df_run['Distance (km)']['2018':'2013'].resample('W').bfill()
...
df_run_hr_all = df_run['Average Heart Rate (bpm)']['2018':'2015-03']
